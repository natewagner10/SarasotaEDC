...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 29 17:58:34 2020
...
all_train_data = pd.read_csv('/Users/natewagner/Documents/Surveys/Question5_pixel_with_actual.csv')
...
train_img = train_img.reshape(5760,95,95,1)
test_img = test_img.reshape(1440,95,95,1)
...
#create model
model = Sequential()
model.add(Conv2D(32, kernel_size=7, activation='relu', input_shape=(95,95,1)))
...
# to save model
model.save('/Users/natewagner/Documents/Surveys/Models/Question5_CNN.h5')
